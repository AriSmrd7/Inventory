...
$brg = $pengadaan->showBarang();
$sup = $pengadaan->showSupplier();
                    ...
                    <div class="container-fluid">
					    <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Pengadaan Barang</h2>
                                    <a class="btn" href="pengadaan.php">
                        ...
                        <div class="col-lg-12">
                                <div class="card">
									...
									<br>
									<div class="col-lg-10">
                                        <form method="post" action="pengadaan_proses.php?action=add" enctype="multipart/form-data" class="form-horizontal">
