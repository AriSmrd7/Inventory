                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                                <div class="card">
									...
									<br>
									<div class="col-lg-10">
                                        <form method="post" action="barang_proses.php?action=add" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-5">
                                                    <label for="text-input" class=" form-control-label">Kode Barang</label>
                                                </div>
                                                <div class="col-8 col-md-5">
                                                    <input type="text" id="text-input" name="kode_barang" class="form-control">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-5">
