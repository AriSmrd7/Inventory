...
<head>
    ...
    <!-- Title Page-->
    <title>Cairo - Halaman Barang</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                                <div class="card">
									...
									<br>
									<div class="col-lg-10">
                                        <form method="post" action="barang_proses.php?action=update" enctype="multipart/form-data" class="form-horizontal">
										<input type="hidden" name="id_barang" value="<?php echo $data_barang['id_barang']; ?>"/>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-8 col-md-5">
                                                    <input type="text" id="text-input" name="kode_barang" value="<?php echo $data_barang['kode_brg']; ?>"  class="form-control" >
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-5">
                                                ...
                                                <div class="col-10 col-md-7">
                                                    <input type="text" id="text-input" name="nama_barang" value="<?php echo $data_barang['nama_brg']; ?>" class="form-control">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-5">
                                                    <label for="text-input" class=" form-control-label">Harga Beli</label>
                                                </div>
												<div class="col-8 col-md-5">
                                                    <input type="text" id="text-input" name="harga" value="<?php echo $data_barang['harga']; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-5">
                                                    <label for="select" class=" form-control-label">Satuan</label>
                                                </div>
                                                <div class="col-8 col-md-5">
                                                    <select name="satuan" id="select" class="form-control">
                                                        <option value="<?php echo $data_barang['satuan_brg']; ?>"><?php echo $data_barang['satuan_brg']; ?></option>
