...
<head>
    ...
    <!-- Title Page-->
    <title>Cairo - Halaman Distribusi</title>
					    ...
					    <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Data Distribusi Barang</h2>
                                    <a class="au-btn au-btn-icon au-btn--blue" href="distribusi_tambah.php">
