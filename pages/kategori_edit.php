                    ...
                    <div class="container-fluid">
					    <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Edit Data Kategori</h2>
                        ...
                        <div class="col-lg-12">
                                <div class="card">
									...
									<br>
									<div class="col-lg-10">
                                        <form method="post" action="kategori_proses.php?action=update" enctype="multipart/form-data" class="form-horizontal">
										<input type="hidden" name="id_kategori" value="<?php echo $kat['id_kategori']; ?>"/>
											<div class="row form-group">
                                                ...
                                                <div class="col-10 col-md-7">
                                                    <input type="text" id="text-input" name="nama" value="<?php echo $kat['nama']; ?>" class="form-control">
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-5">
                                                ...
                                                <div class="col-8 col-md-5">
													...
													if ($kat['status']=="Aktif") {
														echo"
														<option value=".$kat[status].">".$kat[status]."</option>
														<option value=Nonaktif>Nonaktif</option>";
													} 
													elseif ($kat['status']=="Nonaktif") {
														echo"
														<option value=".$kat[status].">".$kat[status]."</option>
