                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                                <div class="card">
									...
									<br>
									<div class="col-lg-10">
                                        <form method="post" action="supplier_proses.php?action=add" enctype="multipart/form-data" class="form-horizontal">
											...
											<div class="row form-group">
												...
												<div class="col-9 col-md-7">
                                                    <textarea id="text-input" name="alamat" class="form-control"></textarea>
                                                </div>
                                            </div>
         									<div class="row form-group">
                                                <div class="col col-md-5">
                                                ...
                                                <div class="col-8 col-md-5">
                                                    <input type="text" id="text-input" name="telepon" class="form-control">
                                                </div>
                                            </div>
											<br>
											<center>
